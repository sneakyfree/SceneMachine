...
class AgentAction:
    ...
    def _summarize_outputs(self) -> Optional[Dict[str, Any]]:
        if not self.outputs:
            return None
...
class ParserAgent(BaseAgent):
    ...
    async def _parse_screenplay(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        from scenemachine.parsers import parse_fountain, parse_pdf, parse_fdx
...
class Orchestrator:
    ...
    async def run_pipeline(self, screenplay_path: str, file_format: str) -> Dict[str, Any]:
        ...
        char_result = await self.character.execute({
