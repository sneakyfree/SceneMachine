...
export function DnaStrandDemoPage() {
    const [activeSection, setActiveSection] = useState<'overview' | 'blockers' | 'pipeline' | 'agents'>('overview');
    const [demoProjectId] = useState('demo-project-001');

    // Simulated agent statuses
    const agents = [
        { name: 'Parser Agent', role: 'Screenplay analysis', status: 'complete' as const, icon: FileText },
        { name: 'Character Agent', role: 'Reference generation', status: 'complete' as const, icon: Users },
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="text-center py-8">
                            ...
                            <p className="text-surface-400 mt-2 max-w-2xl mx-auto">
                                The complete DNA Strand implementation transforms screenplays into movies
                                using multi-agent orchestration, quality gating, and human-in-the-loop approval.
                            </p>
                        </div>
