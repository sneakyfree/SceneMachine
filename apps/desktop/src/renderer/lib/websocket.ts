...
export function getConnectionStatusInfo(
    ...
    switch (state) {
        case ConnectionState.CONNECTED:
            return { label: 'Connected', message: 'Real-time updates active', color: 'green', icon: 'connected' };
        case ConnectionState.CONNECTING:
            return { label: 'Connecting', message: 'Establishing connection...', color: 'blue', icon: 'reconnecting' };
        ...
        case ConnectionState.POLLING:
            return { label: 'Polling', message: 'Using fallback polling', color: 'yellow', icon: 'polling' };
        case ConnectionState.ERROR:
            return { label: 'Error', message: error || 'Connection error', color: 'red', icon: 'error' };
        case ConnectionState.DISCONNECTED:
        default:
            return { label: 'Disconnected', message: 'No connection', color: 'red', icon: 'disconnected' };
    }
}
