...
export const DEFAULT_SHORTCUTS: ShortcutDefinition[] = [
  ...
  {
    id: 'timeline.frameForward',
    key: 'ArrowRight',
    description: 'Next Frame',
    category: 'timeline',
  },
  {
    id: 'timeline.frameBack',
    key: 'ArrowLeft',
    description: 'Previous Frame',
    category: 'timeline',
  },
  {
    id: 'timeline.jumpForward',
    key: 'ArrowRight',
    shift: true,
  ...
  // Generation shortcuts
  {
    ...
    key: 'g',
    ctrl: true,
    description: 'Queue Selected',
    category: 'generation',
  },
  {
    id: 'generation.queueAll',
    key: 'g',
    ctrl: true,
    shift: true,
 ...
 */
export function findConflicts(shortcuts: ShortcutDefinition[]): Map<string, ShortcutDefinition[]> {
