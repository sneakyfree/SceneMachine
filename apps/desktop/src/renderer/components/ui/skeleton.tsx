...
export const Skeleton: React.FC<{
    ...
    animation = 'shimmer',
        ...
        const animationStyles = {
            shimmer: 'animate-shimmer bg-gradient-to-r from-surface-800 via-surface-700 to-surface-800 bg-[length:200%_100%]',
...
export const SkeletonTable: React.FC<{
    ...
    <div className={cn('border border-surface-700 rounded-lg overflow-hidden', className)}>
        ...
        {Array.from({ length: rows }).map((_, rowIdx) => (
            <div
                key={rowIdx}
                className="flex gap-4 p-3 border-b border-surface-700 last:border-b-0"
            >
...
export const SkeletonForm: React.FC<{
    ...
    <div className={cn('space-y-4', className)}>
        ...
        {hasSubmit && (
            <Skeleton variant="rectangular" width={120} height={40} className="mt-4" />
        )}
    </div>
);
