...
export function QualityRadarChart({
    ...
    if (loading) {
        return (
            <div className="quality-radar-loading" style={{
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                padding: compact ? '12px' : '24px', gap: '8px',
    ...
    const hoveredData = hoveredDim
        ? dims.find((d) => d.dimension === hoveredDim)
        : null;
    ...
    return (
        ...
        >
            ...
            <div style={{
                ...
                <div style={{
                    fontSize: '18px', fontWeight: 700, color: overallColor,
                }}>
                ...
                <div style={{
                    ...
                    {hoveredData.issues.length > 0 && (
                        <div style={{ color: '#f59e0b' }}>
                            Issues: {hoveredData.issues.join(', ')}
                        </div>
                    )}
                    {hoveredData.notes && (
            ...
            {!compact && review.recommendations.length > 0 && (
                <div style={{ marginTop: '12px' }}>
                    <div style={{
                        ...
                        color: 'var(--text-secondary, #999)', marginBottom: '6px',
                        letterSpacing: '0.5px',
                    }}>
                        Recommendations
                    </div>
                    {review.recommendations.map((rec, i) => (
                        <div
                            key={i}
                            style={{
                                fontSize: '12px', color: 'var(--text-secondary, #ccc)',
                                padding: '4px 0', borderBottom: '1px solid var(--border-secondary, #333)',
                            }}
                        >
                            • {rec}
                        </div>
