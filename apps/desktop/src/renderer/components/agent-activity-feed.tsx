...
function StatusBadge({ status }: { status: string }) {
    ...
    return (
        <span style={{
            ...
            {status === 'running' && <span className="pulse-dot" style={{
            ...
            {agents.map((agent) => (
                <button
                    ...
                    style={{
                        ...
                        border: 'none',
                        cursor: 'pointer',
                        background: logFilter === agent.type
...
export function AgentActivityFeed() {
    const { actionLogs, isLoadingLogs, fetchActionLogs, fetchAgents, agents, totalCost, fetchTotalCost } = useCrewStore();
