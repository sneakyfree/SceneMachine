    ...
    if (compact) {
        return (
            <div className={cn('flex items-center gap-2 text-xs font-mono', className)}>
                ...
                {memoryUsage && (
                    <span className="text-surface-400">{memoryUsage.toFixed(0)} MB</span>
                )}
            </div>
        );
    }
        ...
        <div className={cn('bg-surface-900 rounded-lg p-4', className)}>
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-surface-800 rounded p-2">
                    ...
                    <div className={cn('text-lg font-mono', fps >= 55 ? 'text-green-400' : fps >= 30 ? 'text-yellow-400' : 'text-red-400')}>
                        {fps}
                    </div>
                </div>
                ...
                <div className="bg-surface-800 rounded p-2">
                    ...
                    <div className={cn('text-lg font-mono', vitals.lcp ? getRatingColor(getMetricRating('lcp', vitals.lcp)) : '')}>
                ...
                <div className="bg-surface-800 rounded p-2">
                    ...
                    <div className={cn('text-lg font-mono', vitals.fid ? getRatingColor(getMetricRating('fid', vitals.fid)) : '')}>
                ...
                <div className="bg-surface-800 rounded p-2">
                    ...
                    <div className={cn('text-lg font-mono', vitals.cls !== null ? getRatingColor(getMetricRating('cls', vitals.cls)) : '')}>
                ...
                <div className="bg-surface-800 rounded p-2">
                    ...
                    <div className={cn('text-lg font-mono', vitals.ttfb ? getRatingColor(getMetricRating('ttfb', vitals.ttfb)) : '')}>
...
export const LazyComponent: React.FC<{
    ...
    <React.Suspense fallback={fallback || <div className="animate-pulse bg-surface-700 rounded h-32" />}>
        {children}
    </React.Suspense>
);
