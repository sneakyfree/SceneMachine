...
const MODE_INFO: Record<string, { icon: typeof Shield; label: string; description: string }> = {
    balanced: {
        icon: Shield,
        label: 'Balanced',
        description: 'Moderate character consistency with creative freedom for the AI to interpret scenes naturally.',
    },
    strong: {
        icon: Zap,
        label: 'Strong',
        description: 'High character consistency. Best for close-ups and dialogue scenes where face accuracy is critical.',
    },
    face_only: {
        icon: User,
        label: 'Face Only',
        description: 'Preserves facial features while allowing body/clothing variation. Ideal for costume changes.',
    },
};
    ...
    if (isLoading) {
        return (
            <div style={{
                ...
                padding: '16px', color: 'var(--text-secondary, #999)',
            }}>
        ...
        >
            ...
            <div style={{ marginBottom: '16px' }}>
                ...
                <div style={{
                    ...
                    fontSize: '10px', color: 'var(--text-tertiary, #666)',
                    marginTop: '4px',
                }}>
                    <span>Creative</span>
