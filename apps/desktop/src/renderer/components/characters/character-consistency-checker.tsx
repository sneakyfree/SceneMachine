    ...
    <div className="consistency-checker">
      ...
      <div className="shot-grid">
        {shots.map((shot) => {
          ...
          const worstSeverity = shotIssues.reduce(
            (worst, issue) => {
              const severityOrder = { high: 3, medium: 2, low: 1 };
              return severityOrder[issue.severity] > severityOrder[worst] ? issue.severity : worst;
            },
          ...
          return (
            ...
            >
              ...
              <div className="shot-info">
                ...
                <span className="score" style={{ color: getScoreColor(shot.consistencyScore) }}>
      ...
      {shots.length === 0 && (
        <div className="empty-state">No shots to check. Generate some shots first.</div>
      )}
