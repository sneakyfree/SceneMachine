...
function getScoreIcon(score: number) {
    ...
    if (score >= 0.70) return AlertTriangle;
    return XCircle;
}
...
export function FaceSimilarityPanel({
    ...
    if (isLoading) {
        return (
            <div style={{
                ...
                gap: '8px', color: 'var(--text-secondary, #999)',
            }}>
    ...
    return (
        ...
        >
            ...
            {/* Score label */}
            <div style={{
                fontSize: '11px', color: 'var(--text-secondary, #999)',
                marginBottom: '12px',
            }}>
                {getScoreLabel(avgScore)} consistency across {result.comparisons.length} shot{result.comparisons.length !== 1 ? 's' : ''}
            </div>
            ...
            <button
                ...
                style={{
                    ...
                    cursor: 'pointer', color: 'var(--accent-primary, #6366f1)',
