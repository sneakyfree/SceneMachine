        ...
        >
            ...
            <div className="flex items-center gap-3 mb-4">
                <div className={cn(
                    ...
                    plan.id === 'free' ? 'bg-surface-700' :
                        plan.id === 'pro' ? 'bg-brand-500' : 'bg-yellow-500'
                )}>
    ...
    className,
        ...
        <div className={cn(
            ...
            <div className="flex-1">
                <div className="font-medium capitalize">{brand} •••• {last4}</div>
                    ...
                    {invoices.length > 0 ? (
                        <div className="space-y-2">
                            {invoices.slice(0, 5).map((invoice) => (
                                <div key={invoice.id} className="flex items-center justify-between py-2 border-b border-surface-700 last:border-b-0">
                                    <div>
                    ...
                    <div className="bg-surface-800 rounded-lg p-4">
                        ...
                        <div className="space-y-2">
                            {payouts.slice(0, 5).map((payout) => (
                                <div key={payout.id} className="flex items-center justify-between py-2 border-b border-surface-700 last:border-b-0">
                                    <div>
