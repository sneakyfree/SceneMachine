                            ...
                            <form onSubmit={handleSubmit}>
                                        ...
                                        {(['bug', 'feature', 'improvement', 'question'] as const).map(type => (
                                            <button
                                                ...
                                                style={{
                                                    padding: '0.5rem 1rem',
                                                    borderRadius: '0.5rem',
                                                    border: formData.type === type ? '2px solid #6366F1' : '1px solid #374151',
                                        ...
                                        {(['critical', 'high', 'medium', 'low'] as const).map(severity => (
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    borderRadius: '0.5rem',
                                                    border: formData.severity === severity
                                                        ? `2px solid ${SEVERITY_COLORS[severity]}`
                                                        : '1px solid #374151',
                                                    backgroundColor: formData.severity === severity
                                ...
                                <p style={{
                                    ...
                                    Press <kbd style={{
                                        ...
                                        borderRadius: '0.25rem',
                                    }}>Shift+F</kbd> to toggle feedback
                                </p>
                            </form>
                        )}
                    </div>
