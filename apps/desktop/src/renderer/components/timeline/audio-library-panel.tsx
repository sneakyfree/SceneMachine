        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-2 pb-2 space-y-1">
            {filteredItems.length > 0 ? (
              ...
              <div className="text-center py-8 text-surface-500 text-sm">No audio items found</div>
            )}
          </div>

          {/* Drag hint */}
          <div className="p-2 border-t border-surface-700">
            <p className="text-xs text-surface-500 text-center">Drag items to timeline tracks</p>
          </div>
        </div>
      )}
    </div>
